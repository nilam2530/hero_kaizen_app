...
import 'package:hero_kaizen_app/src/features/admin/kaizen_Machine/provider/kaizen_machine_provider.dart';
...
class _AddMachineViewState extends State<AddMachineView> {
  ...
  bool _validateFields(KaizenMachineProvider controller) {
  ...
  Widget _buildFormFields(KaizenMachineProvider controller) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.start,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
