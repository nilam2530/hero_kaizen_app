...
class KaizenMachineProvider with ChangeNotifier {
  ...
  List<KaizenThemeTableModel> newData = List.generate(
    ...
    (index) => KaizenThemeTableModel(
      ...
      status: index % 2 == 0 ? "Enable" : "Enable",
  ...
  void addNewTheme({required String name, required String sortOrder, required String status,}) {
