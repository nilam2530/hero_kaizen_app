...
class _ShellLayoutState extends State<ShellLayout> {
  ...
  Widget build(BuildContext context) {
    ...
    final drawerWidth = dashBoardProvider.isDrawerOpen ? 200.0 : 56.0;
    if (kDebugMode) {
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child: getSideContainer(drawerWidth, dashBoardProvider, context,
            fromDrawer: true),
        width: size.width * .45,
      ),
      body: Stack(
        children: [
          Row(
            children: [
              ...
              size.width < 600
                  ? Container()
                  : getSideContainer(drawerWidth, dashBoardProvider, context,
                      fromDrawer: null),
  ...
  getSideContainer(double drawerWidth, SidemeuController dashBoardProvider,
      ...
      AnimatedContainer(
        ...
        child: SideMenuWidget(
          ...
          isDrawerOpen:
              fromDrawer != null ? true : dashBoardProvider.isDrawerOpen,
