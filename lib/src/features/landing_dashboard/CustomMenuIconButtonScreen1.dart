...
class CustomMenuIconButtonScreen1 extends StatefulWidget {
  const CustomMenuIconButtonScreen1({super.key});

  @override
  State<CustomMenuIconButtonScreen1> createState() =>
      _CustomMenuIconButtonScreen1State();
}

class _CustomMenuIconButtonScreen1State
    extends State<CustomMenuIconButtonScreen1> {
  ...
  Widget _buildMenuIcon() {
    return CompositedTransformTarget(
      link: _layerLink,
      child: IconButton(
        icon: SvgPicture.asset(AppImages.dotWhite, width: 20, height: 20,),
        onPressed: () {
